...
algorithm = "{'type': 'Property', 'value': 'k-means'}"
attribute = "algorithm"
value = algorithm
# The next line creates the query for inserting this attribute in a NGSI-LD context broker if the attribute does not exist it creates it
print(sdm.update_broker(dataModel, subject, attribute, value, serverUrl=serverUrl, updateThenCreate=True))

dockerImage = "{'type': 'Property', 'value': 'Docker image containing the model'}"
attribute = "dockerImage"
value = dockerImage
# The next line creates the query for inserting this attribute in a NGSI-LD context broker if the attribute does not exist it creates it
print(sdm.update_broker(dataModel, subject, attribute, value, serverUrl=serverUrl, updateThenCreate=True))

inputAttributes = {'type': 'Property', 'value': ['minFlow', 'maxFlow', 'waterConsumption']}
attribute = "inputAttributes"
value = inputAttributes
# The next line creates the query for inserting this attribute in a NGSI-LD context broker if the attribute does not exist it creates it
print(sdm.update_broker(dataModel, subject, attribute, value, serverUrl=serverUrl, updateThenCreate=True))

outputAttributes = {'type': 'Property', 'value': ['consumptionNextDay', 'consumptionNextWeek']}
